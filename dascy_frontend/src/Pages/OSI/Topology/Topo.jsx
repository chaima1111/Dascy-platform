      ...
      <div ref={nextSectionRef}>
        <div className="dascy__topo">
          ...
          <div className="dascy__topo-container">
            ...
            <label
              htmlFor="c1"
              className="dascy__topo-card"
              onClick={() => handleCardClick("MESH TOPOLOGY")}
            >
            ...
            <label
              htmlFor="c2"
              className="dascy__topo-card"
              onClick={() => handleCardClick("STAR TOPOLOGY")}
            >
              <div className="dascy__topo-row">
            ...
            <label
              htmlFor="c3"
              className="dascy__topo-card"
              onClick={() => handleCardClick("RING TOPOLOGY")}
            >
              <div className="dascy__topo-row">
            ...
            <label
              htmlFor="c4"
              className="dascy__topo-card"
              onClick={() => handleCardClick("BUS TOPOLOGY")}
            >
              <div className="dascy__topo-row">
